input_text = '''"CODIGO_CNAE_FISCAL"; "DESCRICAO_CNAE_FISCAL";
...
cleaned = []
for line in lines:
    line = line.strip().replace('"', '')  # remove aspas
    line = line.replace('; ', ';')        # remove espaço após ponto e vírgula
    cleaned.append(line)

# Salvar em CSV
with open("cnae.csv", "w", encoding="utf-8") as f:
    f.write("\n".join(cleaned))

print("Arquivo 'cnae.csv' gerado com sucesso!")
